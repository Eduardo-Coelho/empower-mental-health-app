import { AddSymptoms, Symptom } from '@/components/addSymptoms/AddSymptoms';
...
export const Home = ({ navigation }: HomeProps) => {
  ...
  const handleAdd = (symptom: Symptom) =>
    setSymptoms((prev) => [...prev, symptom]);

  return (
    <Layout navigation={navigation}>
      <DailyReport report={{ ...mockProfile, recordedSymptoms: symptoms }} />
      <AddSymptoms onAdd={handleAdd} />
    </Layout>
  );
};
